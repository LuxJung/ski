...
public class a_Test extends AppCompatActivity {
    ...
    private EditText mEditTextName;//이름 입력
    private EditText mEditTextCountry;//나라입력
    private TextView mTextViewResult;//디버깅 결과
    private ArrayList<PersonalData> mArrayList; //등록된 유저리스트
    private UsersAdapter mAdapter; //유저 정보 어뎁터
    private RecyclerView mRecyclerView; //리사이클러뷰
    private EditText mEditTextSearchKeyword; //유저 검색입력
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                task.execute("http://" + IP_ADDRESS + "dbAndroidInsert.php", name,country);
        ...
        button_search.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                task.execute( "http://" + IP_ADDRESS + "dbAndroidQuery.php", Keyword);
            }
        });
        ...
        button_all.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                GetData task = new GetData();
                task.execute( "http://" + IP_ADDRESS + "dbAndroidGetJSON.php", "");
            }
        });
    ...
    class InsertData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(a_Test.this,
